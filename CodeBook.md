...
* Subjects: IDs of persons who carried out the experiment, from 1 to 30
* Features used in assignment (only measurements on mean and standard deviation, as in `features.txt`):
```
1 tBodyAcc-mean()-X
2 tBodyAcc-mean()-Y
3 tBodyAcc-mean()-Z
