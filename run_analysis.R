...
165,166,201,202,214,215,227,228,240,241,253,254,266,267,268,269,270,271,294,295,296,345,346,347,348,349,350,
373,374,375,424,425,426,427,428,429,452,453,454,503,504,513,516,517,526,529,530,539,542,543,552,555,556,557,
558,559,560,561)]
...
m_mean<-aggregate(m_merged[,4:89], by=list(activity=m_merged$activity, subject=m_merged$subject), 
FUN=mean, na.rm=TRUE)
